...
class Net(nn.Module):
    def __init__(self):
        ...
        self.fc0 = nn.Linear(2244, dimension_, bias=False)
...
def test_represent(model, device, test_loader,test_loader_,threshold_):
    ...
    with torch.no_grad():
        ...
        print(count)
        print(len(test_loader_.dataset))
...
def main():
    ...
    if test_hdc:
        repre = test_represent(model, device, train_loader,test_loader,600)
        repre = test_represent(model, device, train_loader,test_loader,685)
        repre = test_represent(model, device, train_loader,test_loader,690)
        repre = test_represent(model, device, train_loader,test_loader,695)
        repre = test_represent(model, device, train_loader,test_loader,300)
        repre = test_represent(model, device, train_loader,test_loader,310)    
