...
def test(model, device, test_loader):
    ...
    return correct
def test_represent(model, device, test_loader,test_loader_,threshold_):
    model.eval()
    test_loss = 0
    correct = 0
...
def main():
    ...
    # print('save', ACC)
    if test_hdc:
        repre = test_represent(model, device, train_loader,test_loader,1760)
        repre = test_represent(model, device, train_loader,test_loader,1780)
        repre = test_represent(model, device, train_loader,test_loader,1800)
        repre = test_represent(model, device, train_loader,test_loader,1810)
        repre = test_represent(model, device, train_loader,test_loader,1820)
        repre = test_represent(model, device, train_loader,test_loader,1830)
        repre = test_represent(model, device, train_loader,test_loader,1850)
        repre = test_represent(model, device, train_loader,test_loader,1870)
        repre = test_represent(model, device, train_loader,test_loader,1880)
