...
class Net_plain(nn.Module):
    def __init__(self):
        ...
        self.fc0 = nn.Linear(1851, 2 * dimension_, bias=True)
        self.Bn0 = nn.BatchNorm1d(2 * dimension_)

        self.fc0_ = nn.Linear(2 * dimension_, dimension_, bias=True)
...
def main():
    ...
    if test_hdc:
        repre = test_represent(model_plain, device, train_loader,test_loader,55)
        repre = test_represent(model_plain, device, train_loader,test_loader,60)
        repre = test_represent(model_plain, device, train_loader,test_loader,100)
        repre = test_represent(model_plain, device, train_loader,test_loader,200)
